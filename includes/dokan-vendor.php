<div class="harmony-content dokan-edit-row">
    ...
    <div class="dokan-section-content harmony-video-content">
        <h3 class="harmony-dk-sub-heading"><?php esc_html_e( 'Product Video', 'harmony') ?> </h3>
        ...
        <div class="harmony_type_container">
            <label for="harmony_youtube_video"><input type="radio" name="harmony_featured_video_type" value="youtube_video" id="harmony_youtube_video" <?php echo esc_attr( $youtube_video_radio ); ?>> YouTube</label>
            <label for="harmony_wpmedia_video"><input type="radio" name="harmony_featured_video_type" value="wpmedia_video" id="harmony_wpmedia_video" <?php echo esc_attr( $wpmedia_video_radio ); ?>> File Upload</label>
        </div>
    ...
    <div class="dokan-section-content harmony-audio-content">
        <h3 class="harmony-dk-sub-heading"><?php esc_html_e( 'Product Audio', 'harmony') ?> </h3>
        ...
        <div class="harmony_type_container">
            <label for="harmony_sc_audio"><input type="radio" name="harmony_product_audio_type" value="sc_audio" id="harmony_sc_audio" <?php echo esc_attr( $sc_audio_radio ); ?>> SoundCloud</label>
            <label for="harmony_wpmedia_audio"><input type="radio" name="harmony_product_audio_type" value="wpmedia_audio" id="harmony_wpmedia_audio" <?php echo esc_attr( $wpmedia_audio_radio ); ?>> File Upload</label>
        </div>
